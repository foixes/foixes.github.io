...
信息：4.0.0
解决方案：配置文件中调大__min_full_resource_pool_memory参数的值2147483648，alter system__min_full_resource_pool_memory=2147483648，隐藏参数查看方式SELECT * FROM oceanbase.__all_virtual_sys_parameter_stat WHERE name='__min_full_resource_pool_memory';
